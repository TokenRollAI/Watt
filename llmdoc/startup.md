...
1. [must/project-basics.md](must/project-basics.md) —— Watt 是什么、仓库结构、工具链、质量门。
2. [must/core-invariants.md](must/core-invariants.md) —— 必须遵守的硬不变量（决策 4、Session XOR Run 等）。
